...
const uint16_t PROGMEM ab_combo[3] = {KC_A, KC_B, COMBO_END};
const uint16_t PROGMEM jk_combo[3] = {KC_J, KC_K, COMBO_END};


combo_t key_combos[COMBO_COUNT] = {
    [AB_ESC] = COMBO(ab_combo, KC_LBRC),
    [JK_TAB] = COMBO(jk_combo, KC_RBRC)
};